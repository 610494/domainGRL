...
SEARCH_DIRS=(
    ...
    # "/share/nas169/wago/MultiGauss/AES/results_aes_baselines_WD1e-3/baseline_proba/lambda0.0"
...
PRED_ROOT_DIR="evaluation_results_batch_w_pred/baselines_WD1e-4"
...
for SEARCH_ROOT in "${SEARCH_DIRS[@]}"; do
    ...
    find "$SEARCH_ROOT" -type d -name "seed${TARGET_SEED}" | while read EXP_SEED_DIR; do
        ...
        python inference_aes_baseline.py \
