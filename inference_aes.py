...
from model.model_domainGRL import DANNProjectionHead
...
def parse_args():
    ...
    parser.add_argument("--num_domains", type=int, default=6, help="number of dataset domains")
...
def main():
    ...
    model = DANNProjectionHead(
        in_shape=dataset.features_shape, num_domains=args.num_domains
    ).to(device)
