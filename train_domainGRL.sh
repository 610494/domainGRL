...
# =========================
N=1  
BASE_OUTPUT_ROOT="results_aes_domain_grl"
USE_WANDB=true
...
declare -A CONFIGS
CONFIGS["domainGRL_proba"]="configs/domainGRL.gin" # 確保 gin 檔名正確
...
DOMAIN_STRATEGIES=("k-means" "random")
DOMAIN_NUMS=(10) 
